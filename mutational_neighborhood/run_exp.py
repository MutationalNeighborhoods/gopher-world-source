...
def run_exp(num_split, exp_name, nice):
    ...
    func_name = ''
    func_name_to_runnable = {'single':'explore_single_mutation','double':'explore_double_mutation', 'triple':'explore_triple_mutation'}
    try:
    ...
    return func, sub_df_name, output_file_name
    print('complete')
